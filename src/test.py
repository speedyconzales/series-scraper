...
from search_for_links import get_redirect_link
import re
...
# Example usage
url = "https://dooood.com/e/qq2tg2bt3rzw"  # Replace with your video stream URL
output_file = "output_videoo.html"  # Replace with the desired output file name
